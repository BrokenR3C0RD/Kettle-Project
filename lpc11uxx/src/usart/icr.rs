...
pub type IRDAEN_R = crate::BitReader<IRDAEN_A>;
...
pub type IRDAEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, ICR_SPEC, IRDAEN_A, O>;
impl<'a, const O: u8> IRDAEN_W<'a, O> {
...
pub type IRDAINV_R = crate::BitReader<IRDAINV_A>;
...
pub type IRDAINV_W<'a, const O: u8> = crate::BitWriter<'a, u32, ICR_SPEC, IRDAINV_A, O>;
impl<'a, const O: u8> IRDAINV_W<'a, O> {
...
pub type FIXPULSEEN_R = crate::BitReader<FIXPULSEEN_A>;
...
pub type FIXPULSEEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, ICR_SPEC, FIXPULSEEN_A, O>;
impl<'a, const O: u8> FIXPULSEEN_W<'a, O> {
...
pub type PULSEDIV_R = crate::FieldReader<u8, PULSEDIV_A>;
...
impl PULSEDIV_R {
    ...
    #[doc = "Checks if the value of the field is `_3_DIV_16_X`"]
    #[inline(always)]
    pub fn is_3_div_16_x(&self) -> bool {
        *self == PULSEDIV_A::_3_DIV_16_X
    }
    #[doc = "Checks if the value of the field is `_2_X`"]
    #[inline(always)]
    pub fn is_2_x(&self) -> bool {
        *self == PULSEDIV_A::_2_X
    }
    #[doc = "Checks if the value of the field is `_4_X`"]
    #[inline(always)]
    pub fn is_4_x(&self) -> bool {
        *self == PULSEDIV_A::_4_X
    }
    #[doc = "Checks if the value of the field is `_8_X`"]
    #[inline(always)]
    pub fn is_8_x(&self) -> bool {
        *self == PULSEDIV_A::_8_X
    }
    #[doc = "Checks if the value of the field is `_16_X`"]
    #[inline(always)]
    pub fn is_16_x(&self) -> bool {
        *self == PULSEDIV_A::_16_X
    }
    #[doc = "Checks if the value of the field is `_32_X`"]
    #[inline(always)]
    pub fn is_32_x(&self) -> bool {
        *self == PULSEDIV_A::_32_X
    }
    #[doc = "Checks if the value of the field is `_64_X`"]
    #[inline(always)]
    pub fn is_64_x(&self) -> bool {
        *self == PULSEDIV_A::_64_X
    }
    #[doc = "Checks if the value of the field is `_128_X`"]
    #[inline(always)]
    pub fn is_128_x(&self) -> bool {
        *self == PULSEDIV_A::_128_X
    }
}
#[doc = "Field `PULSEDIV` writer - Configures the pulse width when FixPulseEn = 1."]
pub type PULSEDIV_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, ICR_SPEC, u8, PULSEDIV_A, 3, O>;
impl<'a, const O: u8> PULSEDIV_W<'a, O> {
    #[doc = "3 / (16 x baud rate)"]
    #[inline(always)]
    pub fn _3_div_16_x(self) -> &'a mut W {
        self.variant(PULSEDIV_A::_3_DIV_16_X)
    }
    #[doc = "2 x TPCLK"]
    #[inline(always)]
    pub fn _2_x(self) -> &'a mut W {
        self.variant(PULSEDIV_A::_2_X)
    }
    #[doc = "4 x TPCLK"]
    #[inline(always)]
    pub fn _4_x(self) -> &'a mut W {
        self.variant(PULSEDIV_A::_4_X)
    }
    #[doc = "8 x TPCLK"]
    #[inline(always)]
    pub fn _8_x(self) -> &'a mut W {
        self.variant(PULSEDIV_A::_8_X)
    }
    #[doc = "16 x TPCLK"]
    #[inline(always)]
    pub fn _16_x(self) -> &'a mut W {
        self.variant(PULSEDIV_A::_16_X)
    }
    #[doc = "32 x TPCLK"]
    #[inline(always)]
    pub fn _32_x(self) -> &'a mut W {
        self.variant(PULSEDIV_A::_32_X)
    }
    #[doc = "64 x TPCLK"]
    #[inline(always)]
    pub fn _64_x(self) -> &'a mut W {
        self.variant(PULSEDIV_A::_64_X)
    }
    #[doc = "128 x TPCLK"]
    #[inline(always)]
    pub fn _128_x(self) -> &'a mut W {
        self.variant(PULSEDIV_A::_128_X)
    }
}
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn irdaen(&mut self) -> IRDAEN_W<0> {
        IRDAEN_W::new(self)
    }
    #[doc = "Bit 1 - Serial input inverter"]
    #[inline(always)]
    #[must_use]
    pub fn irdainv(&mut self) -> IRDAINV_W<1> {
        IRDAINV_W::new(self)
    }
    #[doc = "Bit 2 - IrDA fixed pulse width mode."]
    #[inline(always)]
    #[must_use]
    pub fn fixpulseen(&mut self) -> FIXPULSEEN_W<2> {
        FIXPULSEEN_W::new(self)
    }
    #[doc = "Bits 3:5 - Configures the pulse width when FixPulseEn = 1."]
    #[inline(always)]
    #[must_use]
    pub fn pulsediv(&mut self) -> PULSEDIV_W<3> {
        PULSEDIV_W::new(self)
    }
