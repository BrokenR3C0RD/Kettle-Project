...
pub type STOPA_R = crate::FieldReader<u16, u16>;
#[doc = "Field `STOPA` writer - BIST stop address: Bit 0 is fixed zero since only even addresses are allowed."]
pub type STOPA_W<'a, const O: u8> = crate::FieldWriter<'a, u32, EEMSSTOP_SPEC, u16, u16, 14, O>;
...
pub type DEVSEL_R = crate::BitReader<bool>;
...
pub type DEVSEL_W<'a, const O: u8> = crate::BitWriter<'a, u32, EEMSSTOP_SPEC, bool, O>;
...
pub type STRTBIST_W<'a, const O: u8> = crate::BitWriter<'a, u32, EEMSSTOP_SPEC, bool, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn devsel(&mut self) -> DEVSEL_W<30> {
        DEVSEL_W::new(self)
    }
    #[doc = "Bit 31 - BIST start bit Setting this bit will start the BIST. This bit is self-clearing."]
    #[inline(always)]
