...
pub type PMODE0_R = crate::BitReader<bool>;
...
pub type PMODE0_W<'a, const O: u8> = crate::BitWriter<'a, u32, ISEL_SPEC, bool, O>;
...
pub type PMODE1_R = crate::BitReader<bool>;
...
pub type PMODE1_W<'a, const O: u8> = crate::BitWriter<'a, u32, ISEL_SPEC, bool, O>;
...
pub type PMODE2_R = crate::BitReader<bool>;
...
pub type PMODE2_W<'a, const O: u8> = crate::BitWriter<'a, u32, ISEL_SPEC, bool, O>;
...
pub type PMODE3_R = crate::BitReader<bool>;
...
pub type PMODE3_W<'a, const O: u8> = crate::BitWriter<'a, u32, ISEL_SPEC, bool, O>;
...
pub type PMODE4_R = crate::BitReader<bool>;
...
pub type PMODE4_W<'a, const O: u8> = crate::BitWriter<'a, u32, ISEL_SPEC, bool, O>;
...
pub type PMODE5_R = crate::BitReader<bool>;
...
pub type PMODE5_W<'a, const O: u8> = crate::BitWriter<'a, u32, ISEL_SPEC, bool, O>;
...
pub type PMODE6_R = crate::BitReader<bool>;
...
pub type PMODE6_W<'a, const O: u8> = crate::BitWriter<'a, u32, ISEL_SPEC, bool, O>;
...
pub type PMODE7_R = crate::BitReader<bool>;
...
pub type PMODE7_W<'a, const O: u8> = crate::BitWriter<'a, u32, ISEL_SPEC, bool, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pmode0(&mut self) -> PMODE0_W<0> {
        PMODE0_W::new(self)
    }
    #[doc = "Bit 1 - Selects the interrupt mode for each pin interrupt. Bit n configures the pin interrupt selected in PINTSELn. 0 = Edge sensitive 1 = Level sensitive"]
    #[inline(always)]
    #[must_use]
    pub fn pmode1(&mut self) -> PMODE1_W<1> {
        PMODE1_W::new(self)
    }
    #[doc = "Bit 2 - Selects the interrupt mode for each pin interrupt. Bit n configures the pin interrupt selected in PINTSELn. 0 = Edge sensitive 1 = Level sensitive"]
    #[inline(always)]
    #[must_use]
    pub fn pmode2(&mut self) -> PMODE2_W<2> {
        PMODE2_W::new(self)
    }
    #[doc = "Bit 3 - Selects the interrupt mode for each pin interrupt. Bit n configures the pin interrupt selected in PINTSELn. 0 = Edge sensitive 1 = Level sensitive"]
    #[inline(always)]
    #[must_use]
    pub fn pmode3(&mut self) -> PMODE3_W<3> {
        PMODE3_W::new(self)
    }
    #[doc = "Bit 4 - Selects the interrupt mode for each pin interrupt. Bit n configures the pin interrupt selected in PINTSELn. 0 = Edge sensitive 1 = Level sensitive"]
    #[inline(always)]
    #[must_use]
    pub fn pmode4(&mut self) -> PMODE4_W<4> {
        PMODE4_W::new(self)
    }
    #[doc = "Bit 5 - Selects the interrupt mode for each pin interrupt. Bit n configures the pin interrupt selected in PINTSELn. 0 = Edge sensitive 1 = Level sensitive"]
    #[inline(always)]
    #[must_use]
    pub fn pmode5(&mut self) -> PMODE5_W<5> {
        PMODE5_W::new(self)
    }
    #[doc = "Bit 6 - Selects the interrupt mode for each pin interrupt. Bit n configures the pin interrupt selected in PINTSELn. 0 = Edge sensitive 1 = Level sensitive"]
    #[inline(always)]
    #[must_use]
    pub fn pmode6(&mut self) -> PMODE6_W<6> {
        PMODE6_W::new(self)
    }
    #[doc = "Bit 7 - Selects the interrupt mode for each pin interrupt. Bit n configures the pin interrupt selected in PINTSELn. 0 = Edge sensitive 1 = Level sensitive"]
    #[inline(always)]
    #[must_use]
    pub fn pmode7(&mut self) -> PMODE7_W<7> {
        PMODE7_W::new(self)
    }
