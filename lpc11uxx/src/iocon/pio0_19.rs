...
pub type FUNC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PIO0_19_SPEC, u8, FUNC_A, 3, O>;
...
pub type HYS_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_19_SPEC, HYS_A, O>;
...
pub type INV_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_19_SPEC, INV_A, O>;
