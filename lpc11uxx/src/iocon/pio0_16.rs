...
pub type FUNC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PIO0_16_SPEC, u8, FUNC_A, 3, O>;
...
pub type ADMODE_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_16_SPEC, ADMODE_A, O>;
...
pub type FILTR_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_16_SPEC, FILTR_A, O>;
