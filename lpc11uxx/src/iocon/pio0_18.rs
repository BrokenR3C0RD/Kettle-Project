...
pub type FUNC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PIO0_18_SPEC, u8, FUNC_A, 3, O>;
...
pub type MODE_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, PIO0_18_SPEC, u8, MODE_A, 2, O>;
...
pub type HYS_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_18_SPEC, HYS_A, O>;
...
pub type INV_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_18_SPEC, INV_A, O>;
...
pub type OD_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_18_SPEC, OD_A, O>;
