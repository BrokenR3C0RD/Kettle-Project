...
pub type AP_CLK_R = crate::BitReader<AP_CLK_A>;
...
pub type POL_CLK_W<'a, const O: u8> = crate::BitWriter<'a, u32, USBCLKCTRL_SPEC, POL_CLK_A, O>;
impl<'a, const O: u8> POL_CLK_W<'a, O> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ap_clk(&mut self) -> AP_CLK_W<0> {
        AP_CLK_W::new(self)
    }
    #[doc = "Bit 1 - USB need_clock polarity for triggering the USB wake-up interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn pol_clk(&mut self) -> POL_CLK_W<1> {
        POL_CLK_W::new(self)
    }
